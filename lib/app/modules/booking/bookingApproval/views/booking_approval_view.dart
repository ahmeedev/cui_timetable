          ...
          children: [
                ...
                ? Card(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          'Your request has been queued, the response time depends upon the admin.',
                  ...
                  children: [
                    Text(
                      ...
                      style: textTheme.titleMedium!.copyWith(
                        fontWeight: FontWeight.w900,
                        color: Colors.black,
                        fontSize: textTheme.titleMedium!.fontSize! + 1,
                      ),
                    ),
                    kHeight,
                    Text(
            ...
            Obx(() => controller.isPosted.value
                ? Row(
                    ...
                    children: [
                      Text("Did not got response from the admin yet?",
                          style:
