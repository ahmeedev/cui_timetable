...
class TeacTeacDayTile extends GetView<TeacTeacController> {
  final String day;
  // final String dayKey;
  final Rx<bool> state;
  final int index;
...
class TeacTeacLectureTile extends GetView<TeacTeacController> {
  final int index;
  const TeacTeacLectureTile({Key? key, required this.index}) : super(key: key);
